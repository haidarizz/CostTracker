...
{
    partial class AddExpenses : Form
    {
        public User Pengguna;
        public AddExpenses(User pengguna)
        {
            InitializeComponent();
            Pengguna = pengguna;
        ...
        private void btnSaveExpenses_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                sql = @"select * from ct_insert_outcome(:_id_user,:_in_amount,:_in_account,:_in_category,:_in_date,:_in_note)";
